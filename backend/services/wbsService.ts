 ...
 */
async function recomputeProjectWbs(projectId: number): Promise<void> {
    type WbsUpdate = { model: "phase" | "task"; id: number; wbs: string };
    ...
    const ops: Array<ReturnType<typeof prisma.projectPhase.update> | ReturnType<typeof prisma.task.update>> = [];
