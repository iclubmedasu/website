 ...
 */
export function useTitleCaseInput(initialValue = ''): TitleCaseInputHookReturn {
...
export function titleCaseValue<T>(raw: T): T;
export function titleCaseValue(raw: unknown) {
