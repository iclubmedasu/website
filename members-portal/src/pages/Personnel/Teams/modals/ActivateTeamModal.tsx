...
interface ActivateTeamModalProps {
    isOpen: boolean;
    onClose: () => void;
...
const ActivateTeamModal = ({ isOpen, onClose, onConfirm, team }: ActivateTeamModalProps) => {
    ...
    const handleConfirm = async () => {
        ...
        try {
            ...
            setError(getErrorMessage(err, 'Failed to activate team'));
        } finally {
