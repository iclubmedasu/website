...
interface DeactivateTeamModalProps {
    isOpen: boolean;
    onClose: () => void;
    onConfirm: (teamId: Id) => Promise<void> | void;
...
const DeactivateTeamModal = ({ isOpen, onClose, onConfirm, team }: DeactivateTeamModalProps) => {
    ...
    const handleConfirm = async () => {
        ...
        try {
            ...
            setError(getErrorMessage(err, 'Failed to deactivate team'));
        } finally {
