...
interface AddOfficerSubmitPayload {
    identifier: string;
}
...
interface AddOfficerModalProps {
    isOpen: boolean;
    onClose: () => void;
    onSubmit: (payload: AddOfficerSubmitPayload) => Promise<void> | void;
}
...
function AddOfficerModal({ isOpen, onClose, onSubmit }: AddOfficerModalProps) {
    ...
    const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
        ...
        try {
            ...
            setError(getErrorMessage(err, 'Failed to add officer'));
        } finally {
