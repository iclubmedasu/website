...
import type { PhaseSummary } from '../../../types/backend-contracts';
...
function getErrorMessage(error: unknown): string {
    ...
    return 'Failed to update phase';
}

export default function EditPhaseModal({ phase, onClose, onPhaseUpdated }: EditPhaseModalProps) {
