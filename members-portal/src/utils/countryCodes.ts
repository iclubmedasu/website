...
const BY_CODE_LENGTH: CountryCodeOption[] = [...COUNTRY_CODES].sort((a, b) => (b.code.length - a.code.length));
 ...
 */
export function parsePhoneValue(value: string | null | undefined): ParsedPhoneValue {
