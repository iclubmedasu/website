...
import type { Id, PhaseSummary } from '../../../types/backend-contracts';

interface AddPhaseModalProps {
    projectId: Id;
    existingPhasesCount?: number;
    onClose: () => void;
    onPhaseCreated: (phase: PhaseSummary) => void;
}
...
export default function AddPhaseModal({ projectId, existingPhasesCount = 0, onClose, onPhaseCreated }: AddPhaseModalProps) {
