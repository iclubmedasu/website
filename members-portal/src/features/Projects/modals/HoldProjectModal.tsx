...
interface HoldProjectModalProps {
    project: ProjectModalTarget | null;
    onClose: () => void;
    onHeld: (projectId: Id) => void;
}
...
function getErrorMessage(error: unknown): string {
    ...
    return 'Failed to hold project';
}

function HoldProjectModal({ project, onClose, onHeld }: HoldProjectModalProps) {
