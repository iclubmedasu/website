...
function UserPage() {
    ...
    const joinDateValue =
        (user as { joinDate?: string | null; createdAt?: string | null }).joinDate ??
        (user as { joinDate?: string | null; createdAt?: string | null }).createdAt ??
        null;
    ...
    const getDurationText = (duration: number | string | null | undefined): string => {
    ...
    const getTimelineLineClass = (items: RoleHistoryEntry[]): string => {
        ...
        const firstStartRaw = items[0]?.period?.start;
        const lastStartRaw = items[items.length - 1]?.period?.start;

        if (!firstStartRaw || !lastStartRaw) return 'timeline-line--ascending';

        const firstStart = new Date(firstStartRaw).getTime();
        const lastStart = new Date(lastStartRaw).getTime();
                        ...
                        <div className="user-page-identity">
                            ...
                            {(isDeveloper || inAdministration) && (
                                <div className="user-page-badges">
                                    {isDeveloper && <span className="user-badge user-badge-developer">Developer</span>}
                            ...
                            {!editing ? (
                                    ...
                                    <div className="user-profile-data-grid">
                                        ...
                                        <div className="user-profile-data-item">
                                            ...
                                            <span className="user-profile-data-value">
                                                {user.studentId != null ? String(user.studentId) : 'Officer'}
                                            </span>
                                        </div>
                                        <div className="user-profile-data-item">
                                    ...
                                    <div className="user-profile-team-access">
                                        ...
                                        {teamIds.length === 0 && !isDeveloper ? (
                                            ...
                                            <p className="user-profile-text">
                                                As an administration member, you can view and manage all teams.
                                            </p>
                                        ) : (
                                            <p className="user-profile-text">
                                                On the <strong>Teams</strong> page you only see your team(s). On{' '}
                                                <strong>Members</strong>, <strong>Administration</strong>, and{' '}
                                                <strong>Alumni</strong> you can view all teams.
                                            </p>
                                        )}
                                    </div>
                                </div>
                                ...
                                <div className="user-page-section-card">
                                    <form onSubmit={handleSubmit} className="user-profile-form">
                                        ...
                                        <div className="form-group">
                                            <label htmlFor="user-studentId" className="form-label">
                                                Student ID
                                            </label>
                                            <input
                                                type="text"
                                        ...
                                        <div className="form-group">
                                            <label htmlFor="user-officialEmail" className="form-label">
                                                Official Email
                                            </label>
                                            <input
                                                type="text"
                                        ...
                                        <div className="form-group">
                                            <label htmlFor="user-email2" className="form-label">
                                                Additional Email 2
                                            </label>
                                            <input
                                                type="email"
                                        ...
                                        <div className="form-group">
                                            <label htmlFor="user-email3" className="form-label">
                                                Additional Email 3
                                            </label>
                                            <input
                                                type="email"
                                        ...
                                        <div className="form-group">
                                            <label htmlFor="user-linkedInUrl" className="form-label">
                                                LinkedIn URL
                                            </label>
                                            <input
                                                type="url"
                            ...
                            {historyLoading ? (
                                ...
                                <div className="user-tab-empty-state">
                                    ...
                                    <p className="user-tab-empty-sub">
                                        Your role changes and team assignments will appear here over time.
                                    </p>
                                </div>
                            ) : (
                                (() => {
                                            ...
                                            {roleHistory.map((entry, index) => (
                                                <div key={entry.id} className="timeline-item">
                                                    <div className="timeline-marker">
                                                        <div
                                                            className={`timeline-dot ${getChangeTypeColor(entry.changeType)}`}
                                                        />
                                                    ...
                                                    <div className="timeline-content">
                                                        <div className="timeline-header">
                                                            <span
                                                                className={`change-type-badge ${getChangeTypeColor(entry.changeType)}`}
                                                            >
                                                                {entry.changeType}
                                                            </span>
                    ...
                    {activeTab === 'settings' && (
                        <div className="user-page-section-card">
                            <div className="user-tab-empty-state">
                                ...
                                <p className="user-tab-empty-sub">
                                    Customize how your profile appears to other members. More options coming soon.
                                </p>
                            </div>
                        </div>
                    )}
